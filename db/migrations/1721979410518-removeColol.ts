...
export class RemoveColol1721979410518 implements MigrationInterface {
    name = 'RemoveColol1721979410518'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "temporary_experiment" ("id" varchar PRIMARY KEY NOT NULL, "experiment_name" varchar NOT NULL, "chemical_name" varchar NOT NULL, "chemical_id" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "files" json NOT NULL, "others_attachments" json, "date_collection" varchar NOT NULL, "measurement_technique" varchar NOT NULL, "organization" varchar NOT NULL, "collected_by" varchar NOT NULL, "instrument" varchar NOT NULL, "type" varchar NOT NULL, "normalization" varchar NOT NULL, "createdById" varchar NOT NULL, "createdByName" varchar, "createdByPreferred_username" varchar NOT NULL, "createdByGiven_name" varchar, "createdByFamily_name" varchar, "createdByEmail" varchar NOT NULL)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "experiment" ("id" varchar PRIMARY KEY NOT NULL, "experiment_name" varchar NOT NULL, "chemical_name" varchar NOT NULL, "chemical_id" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "files" json NOT NULL, "others_attachments" json, "date_collection" varchar NOT NULL, "measurement_technique" varchar NOT NULL, "organization" varchar NOT NULL, "collected_by" varchar NOT NULL, "instrument" varchar NOT NULL, "type" varchar NOT NULL, "normalization" varchar NOT NULL, "createdById" varchar NOT NULL, "createdByName" varchar, "createdByPreferred_username" varchar NOT NULL, "createdByGiven_name" varchar, "createdByFamily_name" varchar, "createdByEmail" varchar NOT NULL, "colol" varchar)`);
